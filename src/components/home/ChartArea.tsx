          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="right-side-content">
                ...
                <p>
                  Ethereum is a decentralized, open-source <br /> blockchain
                  with smart contract
                </p>
                <ul className="list-wrap">
                  <li>
                    <span>1</span>Symbol: CIC
                  </li>
                  <li>
                    <span>2</span>Initial Value : 1 ETH = 3177.38 CIC
                  </li>
                  <li>
